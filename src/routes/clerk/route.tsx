                    ...
                    <Alert>
                        ...
                        <AlertDescription>
                            <p className="text-balance">
                                ...
                                <code className={codeBlock}>src/routes/clerk</code>. If you plan to use Clerk as your
                                auth service, you might want to place <code className={codeBlock}>ClerkProvider</code>{" "}
                                at the root route.
                            </p>
                            <p>
